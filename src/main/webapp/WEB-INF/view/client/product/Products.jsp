    ...
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <body>
                ...
                <!-- Fruits Shop Start-->
                <div class="container fruite py-5" style="margin-top: 3rem;">
                                    ...
                                    <c:forEach var="product" items="${products}">
                                        <div class="col-md-6 col-xl-4">
                                            <div class="rounded position-relative fruite-item h-auto">
                                                ...
                                                <div
                                                    class="p-4 text-center border border-secondary border-top-0 rounded-bottom">
                                                    <h4 style="font-size: 1rem;"><a
                                                            href="/products/${product.id}/detail">${product.name}</a>
                                                    </h4>
                                                    <p style="font-size: 1rem;">${product.shortDesc}</p>
