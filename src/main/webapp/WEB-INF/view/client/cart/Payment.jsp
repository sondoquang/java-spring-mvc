                ...
                <div class="container-fluid py-5">
                    <div class="container py-5">
                        <div class="table-responsive">
                            ...
                            <p class="text-success" ${sessionScope.sumCart !=0?"hidden":""}>Giỏ hàng của bạn hiện
                            ...
                            <div class="col-sm-6">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="phone" placeholder="0 xxx xxx xx">
                                    </div>
                                </form>
                            </div>
                            <div class="col-sm-6 ">
                                    ...
                                    <div class="bg-light rounded">
                                        ...
                                        <div class="justify-content-center">
                                            <button
                                                ...
                                                type="button">Xác nhận thanh toán</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
